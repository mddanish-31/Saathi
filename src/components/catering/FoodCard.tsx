      ...
      >
        ...
        <div
          style={{
            ...
            padding: '3px',
            borderRadius: '4px',
            border: isVeg ? '1.5px solid var(--food-veg)' : '1.5px solid var(--food-non-veg)',
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <div
            style={{
              ...
              backgroundColor: isVeg ? 'var(--food-veg)' : 'var(--food-non-veg)',
            }}
          />
        </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              border: '1px solid',
              backgroundColor: isSelected ? 'var(--accent)' : 'var(--bg-surface-soft)',
